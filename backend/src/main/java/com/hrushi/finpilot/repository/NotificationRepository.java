...
public interface NotificationRepository extends JpaRepository<Notification, Long> {
    ...
    // Check recent duplicate notification to avoid spamming alerts
    boolean existsByUserAndTypeAndTitleAndCreatedAtAfter(User user, String type, String title, LocalDateTime after);
}
