...
// POST /expenses — body: { title, amount, category, expenseDate, type, account, notes }
...
// GET /expenses/check-duplicate?date=&title=&amount=&account=
export const checkDuplicateTransaction = (date, title, amount, account = 'Cash') =>
  axiosInstance.get('/expenses/check-duplicate', {
    params: { date, title, amount, account },
  });
