        ...
        <div className="max-w-[1440px] mx-auto px-4 md:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-5">
            ...
            <div className="rounded-2xl border border-gray-200 bg-white p-6 text-center transition-all duration-300 hover:-translate-y-1 hover:border-emerald-300 hover:shadow-[0_15px_45px_rgba(22,163,74,0.15)]">
              <div className="mx-auto w-12 h-12 rounded-xl flex items-center justify-center bg-blue-50 text-blue-600 mb-4 shadow-sm border border-blue-100">
            ...
            <div className="rounded-2xl border border-gray-200 bg-white p-6 text-center transition-all duration-300 hover:-translate-y-1 hover:border-emerald-300 hover:shadow-[0_15px_45px_rgba(22,163,74,0.15)]">
              <div className="mx-auto w-12 h-12 rounded-xl flex items-center justify-center bg-amber-50 text-amber-600 mb-4 shadow-sm border border-amber-100">
            ...
            <div className="rounded-2xl border border-gray-200 bg-white p-6 text-center transition-all duration-300 hover:-translate-y-1 hover:border-emerald-300 hover:shadow-[0_15px_45px_rgba(22,163,74,0.15)]">
              <div className="mx-auto w-12 h-12 rounded-xl flex items-center justify-center bg-emerald-50 text-emerald-600 mb-4 shadow-sm border border-emerald-100">
    ...
    <div className="max-w-[1440px] mx-auto px-4 md:px-8">
      ...
      >
        ...
        <div className="mx-auto flex justify-center mb-6">
          <FinPilotLogo size={72} showText={false} />
        </div>
